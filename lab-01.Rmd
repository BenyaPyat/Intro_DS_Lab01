...
The answers are non applicable, which means that there is missing data
...
na.rm() removes all missing data points and allows you to work with only data that has values
...
This suggests that the higher end numbers are significantly higer in range than the lower end numbers
